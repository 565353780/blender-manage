...
class BlenderRenderer(object):
    ...
    def renderFolder(
        ...
        for shape_filename in shape_filename_list:
            ...
            if not BlenderRenderer.renderFile(shape_file_path, save_image_folder_path, use_gpu, overwrite):
    ...
    def renderFolders(
        ...
        for shape_folder_path, save_image_folder_path in zip(shape_folder_path_list, save_image_folder_path_list):
            BlenderRenderer.renderFolder(shape_folder_path, save_image_folder_path, use_gpu, overwrite)
