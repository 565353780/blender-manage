...
def renderFile(
    ...
    camera_name_list = blender_manager.object_manager.getCollectionObjectNameList(
        "Cameras"
    )
    ...
    if not blender_manager.shading_manager.useObjectColor(object_name):
        ...
        if "pcd" in object_name or "xyz" in object_name:
            blender_manager.pointcloud_manager.createColor(
                object_name, 0.004, "pcd_0", object_name
            )
