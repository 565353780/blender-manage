...
def demo(gauss_sigma: float = 0.01):
    noise_level = str(gauss_sigma).replace('.', '-')
    datat_folder_path = '/Users/fufu/Downloads/Dataset/noise/metric_manifold_result_Noise_' + noise_level + '/ShapeNet/'
    save_image_folder_path = '/Users/fufu/Downloads/Dataset/noise/rendered/' + noise_level + '/'
    overwrite = False
